...
export type LlamaEmbeddingContextOptions = {
    ...
    /**
     * Target transformer layer for embedding extraction.
     * - `-1` (default) = last layer
     * - `0` to `n_layer-1` = extract hidden states from the specified layer
     */
    embdLayer?: number;
};
/**
...
export declare class LlamaEmbeddingContext {
     ...
     * @returns Promise resolving to an array of per-token embedding vectors (each is number[])
     */
    getEmbeddingsForTokens(input: Token[] | string | LlamaText): Promise<number[][]>;
